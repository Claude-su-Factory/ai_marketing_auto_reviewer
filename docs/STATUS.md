...
- **Gemini→Claude parser 마이그레이션 review-deferred items** (2026-04-27, commit `353077a`+fixup): 1-commit refactor (parser provider + runScrape onProgress + ScrapeScreen regex) review 사이클의 deferred 항목. 모두 동작 정상.
